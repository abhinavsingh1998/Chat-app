...
class AboutUSAdapter(private val context: Context, private val list: ArrayList<RecyclerViewItem>):
    ...
    return when (viewType) {
        AboutUSAdapter.VIEW_CORPORATE_PHILOSOPHY -> {
         CorporatePhilosphyViewHolder(
               CorporatePhilosphyAboutUsBinding.inflate(LayoutInflater.from(parent.context),
                    parent,
                    false))
        }
        AboutUSAdapter.VIEW_PRODUCT_CATEGORY -> {
            ProductCategoryViewHolder(
                ProductCategoriesBinding.inflate(LayoutInflater.from(parent.context),
                    parent,
                    false))
        }
        else -> {
            StatsOverviewHolder(StatsAboutusBinding.inflate(LayoutInflater.from(parent.context),
                parent,
                false))
        }
    }
    ...
    private inner class CorporatePhilosphyViewHolder(private val binding: CorporatePhilosphyAboutUsBinding) :
        ...
        fun bind(position: Int) {
            binding.corporatePhillosophyRecyclerList.layoutManager= LinearLayoutManager(context,LinearLayoutManager.HORIZONTAL,false)
    ...
    private fun init(): ArrayList<CorporateAboutusData> {
        ...
        corporateList.add(CorporateAboutusData(R.drawable.management,"Peace of Land" ,"For HoABL, it is not just a piece of land, we believe in the Peace of Land.It is our aim to give back to land more than we take from it.", ))
        corporateList.add(CorporateAboutusData(R.drawable.isustainable_image,"Sustainability" ,"For HoABL, it is not just a piece of land, we believe in the Peace of Land.It is our aim to give back to land more than we take from it.", ))
    ...
    private inner class StatsOverviewHolder(private val binding: StatsAboutusBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int) {
            binding.statsOverviewRecyclerList.layoutManager = GridLayoutManager(context,2)
    ...
    private fun initialize(): ArrayList<StatsAboutusData> {
        ...
        statsList.add(StatsAboutusData("₹4,86,00,000 Cr" ,"Land Transacted","Neque porro quisquam estp qui dolorem ipsu porro quisqua m estp qui ipsu.Neque porro quisquam estp qui dolorem ip" ))
        statsList.add(StatsAboutusData("₹4,86,00,000 Cr","Land Transacted" ,"Neque porro quisquam estp qui dolorem ipsu porro quisqua m estp qui ipsu.Neque porro quisquam estp qui dolorem ip" ))
        statsList.add(StatsAboutusData("₹4,86,00,000 Cr","Gross w.avg Appreciation" ,"Neque porro quisquam estp qui dolorem ipsu porro quisqua m estp qui ipsu.Neque porro quisquam estp qui dolorem ip" ))
        statsList.add(StatsAboutusData("₹4,86,00,000 Cr","Number of Investors" ,"Neque porro quisquam estp qui dolorem ipsu porro quisqua m estp qui ipsu.Neque porro quisquam estp qui dolorem ip" ))
    ...
    private fun initData(): ArrayList<AboutusData> {
        ...
        aboutusList.add(AboutusData(R.drawable.location_image,"Lifestyle" ,"For HoABL, it is not just a piece of land, we believe in the Peace of Land.It is our aim to give back to land more than we take from it.", ))
        aboutusList.add(AboutusData(R.drawable.location_image,"Investment" ,"For HoABL, it is not just a piece of land, we believe in the Peace of Land.It is our aim to give back to land more than we take from it.", ))
        aboutusList.add(AboutusData(R.drawable.location_image,"Consumption" ,"For HoABL, it is not just a piece of land, we believe in the Peace of Land.It is our aim to give back to land more than we take from it.", ))
