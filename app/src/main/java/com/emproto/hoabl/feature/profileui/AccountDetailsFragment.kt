...
import com.emproto.hoabl.feature.home.profileAdapter.AccountDetailsFragmentAdapter
...
class AccountDetailsFragment : Fragment() {
    ...
    private fun initData(): ArrayList<AccountDetailsData> {
        ...
        accountdetailsList.add(AccountDetailsData("Isle of Bliss", " 11th March 2022",
            "See receipt",R.drawable.rupee_icon,"Payment Milestone 2:", "₹20,000"))
        accountdetailsList.add(AccountDetailsData("Yellow Meadow", "10th March 2022","See receipt",R.drawable.rupee_icon,"Payment Milestone 4:","₹80,000" ))
        accountdetailsList.add(AccountDetailsData("Yellow Meadow", "10th March 2022","See receipt",R.drawable.rupee_icon,"Payment Milestone 4:","₹80,000"))
        accountdetailsList.add(AccountDetailsData("Yellow Meadow", "10th March 2022","See receipt" ,R.drawable.rupee_icon,"Payment Milestone 4:","₹80,000"))
