...
import com.emproto.hoabl.feature.home.profileAdapter.FaqViewAdapter
...
class FaqFragment : Fragment() {
    ...
    private fun initData(): ArrayList<FaqData> {
        ...
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_ONE, "Is the Prize quoted per sqft. for ISLE of Bliss all inclusive or there are other cost and expenses?","c","t"))
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_ONE, "Answer will be written here. Answer will Answer will be written here. Answer will Answer will be written here.","h","m"))
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_ONE, "Is the Prize quoted. for ISLE of Bliss all inclusive or there are other cost and expenses?","c","t"))
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_ONE, "Is the Prize quoted. for ISLE of Bliss all inclusive or there are other cost and expenses?","c","t"))
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_ONE, "Is the Prize quoted. for ISLE of Bliss all inclusive or there are other cost and expenses?","c","t"))
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_TWO, "Category 2","Category 2","v"))
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_THREE, "Is the Prize quoted. for ISLE of Bliss all inclusive or there are other cost and expenses?","c","Is the Prize quoted. for ISLE of Bliss all inclusive or there are other cost and expenses?"))
        dataList.add(FaqData(FaqViewAdapter.VIEW_TYPE_THREE, "Is the Prize quoted. for ISLE of Bliss all inclusive or there are other cost and expenses?","c","Is the Prize quoted. for ISLE of Bliss all inclusive or there are other cost and expenses?"))
