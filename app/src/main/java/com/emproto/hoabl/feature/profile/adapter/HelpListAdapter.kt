...
class HelpListAdapter(
    context: Context,
    private val data: List<DataHealthCenter>,
    val itemInterface: HoabelHealthAdapter.HelpItemInterface
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HelpListAdapter.ListHolder {
        ...
        val view =
            HealthCenterViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
