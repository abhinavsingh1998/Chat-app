...
class DestinationAdapter(private val context: Context, private val itemList: List<Story>) :
    RecyclerView.Adapter<DestinationAdapter.DestinationViewHolder>() {

    inner class DestinationViewHolder(var binding: ItemOppDocDestinationBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DestinationViewHolder {
        val view =
            ItemOppDocDestinationBinding.inflate(LayoutInflater.from(parent.context), parent, false)
