...
class AllReceiptsBookingJourneyAdapter(
    private var mContext: Context?,
    private var paymentReceiptList: ArrayList<PaymentReceipt>,
    private var mListener: OnAllDocumentLabelClickListener

) : RecyclerView.Adapter<AllReceiptsBookingJourneyAdapter.ViewHolder>() {
