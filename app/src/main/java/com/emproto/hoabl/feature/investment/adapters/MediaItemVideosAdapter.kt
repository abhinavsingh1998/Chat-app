...
class MediaItemVideosAdapter(
...
) : RecyclerView.Adapter<MediaItemVideosAdapter.ViewHolder>() {

    inner class ViewHolder(var binding: ItemVideosMediaLayoutBinding) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MediaItemVideosAdapter.ViewHolder {
        val view =
            ItemVideosMediaLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
