...
object ApiConstants {
    ...
    const val PROJECT_INVENTORIES = "hoabl-customer/launch-inventory-buckets/{id}"
    const val ADD_INVENTORY = "hoabl-customer/apply-now"
    ...
    const val SEND_MESSAGE = "hoabl-customer/chat/action"
    ...
    const val UPLOAD_DOC = "hoabl-customer/doc-upload"
