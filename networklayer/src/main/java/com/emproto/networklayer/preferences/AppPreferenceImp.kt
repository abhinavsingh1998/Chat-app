...
class AppPreferenceImp @Inject constructor(context: Context) : AppPreference {
    ...
    override fun getWhatsappStatus(): Boolean {
        return getBoolean( WHATSAPP, false)    }
    ...
    override fun setFacilityManagementUrl(url: String) {
        saveString(FACILITY_URL, url)
    }

    override fun getFacility(): String {
        return getString(FACILITY_URL,"")
    }
